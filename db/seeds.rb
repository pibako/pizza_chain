...
Pizza.create([
  { :restaurant_id => 1, :name => "Pepperoni", :price => 32.0, :description => "Some ingredients", :created_at => "2013-09-20 10:01:19", :updated_at => "2013-09-20 10:01:19" },
  ...
  { :restaurant_id => 5, :name => "Cheese", :price => 35.0, :description => "mozzarella, cheddar cheese, authentic tomato sauce", :created_at => "2013-09-20 11:19:34", :updated_at => "2013-09-20 11:19:34" },
  { :restaurant_id => 5, :name => "Ham & Cheese", :price => 22.0, :description => "Ham, Cheese", :created_at => "2013-09-20 11:19:34", :updated_at => "2013-09-20 11:19:34" },
...
Restaurant.create([
  { :name => "Pizza Mia!", :created_at => "2013-09-19 18:03:22", :updated_at => "2013-09-19 18:03:22" },
  { :name => "Pizza Place!", :created_at => "2013-09-19 18:31:00", :updated_at => "2013-09-19 18:31:00" },
  { :name => "Grande Pizza", :created_at => "2013-09-20 08:29:29", :updated_at => "2013-09-20 11:16:54" },
  { :name => "Pizzzzza!", :created_at => "2013-09-20 08:51:29", :updated_at => "2013-09-20 11:19:34" }
], :without_protection => true )



Schedule.create([
  { :restaurant_id => nil, :open_monday => "11:00", :close_monday => "22:00", :open_tuesday => nil, :close_tuesday => nil, :open_wednesday => nil, :close_wednesday => nil, :open_thursday => nil, :close_thursday => nil, :open_friday => nil, :close_friday => nil, :open_saturday => "08:00", :close_saturday => "20:00", :open_sunday => nil, :close_sunday => nil, :created_at => "2013-09-20 09:45:52", :updated_at => "2013-09-20 10:30:30" },
  ...
  { :restaurant_id => 5, :open_monday => "11:00", :close_monday => "20:00", :open_tuesday => nil, :close_tuesday => nil, :open_wednesday => nil, :close_wednesday => nil, :open_thursday => nil, :close_thursday => nil, :open_friday => nil, :close_friday => nil, :open_saturday => "09:00", :close_saturday => "22:00", :open_sunday => nil, :close_sunday => nil, :created_at => "2013-09-20 10:31:12", :updated_at => "2013-09-20 11:19:34" }
], :without_protection => true )
